...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js.f4a89ca1.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, n, t) {
  ...
  "9hQC": [function (require, module, exports) {
    "use strict";
  ...
  "MWph": [function (require, module, exports) {
    "use strict";
  ...
  "8te5": [function (require, module, exports) {
    "use strict";
  ...
  "ON4E": [function (require, module, exports) {
    "use strict";
  ...
  "KdY1": [function (require, module, exports) {
    "use strict";
  ...
  "QeaK": [function (require, module, exports) {
    "use strict";
  ...
  "gZcI": [function (require, module, exports) {
    "use strict";
  ...
  "+gw+": [function (require, module, exports) {
    "use strict";

    var e = require("../dictionary/dictionary_1"),
        r = g(e),
        t = require("../dictionary/dictionary_2"),
        n = g(t),
        i = require("../dictionary/dictionary_3"),
        a = g(i),
        u = require("../dictionary/dictionary_4"),
        o = g(u),
        f = require("../dictionary/dictionary_5"),
        c = g(f),
        l = require("../dictionary/dictionary_6"),
        d = g(l),
        y = require("../dictionary/surnames"),
        s = g(y),
        h = require("./tone"),
        v = g(h);
    ...
    var p = new RegExp(/[\u4E00-\u9FA5]/),
        E = [r.default, n.default, a.default, o.default, c.default, d.default, s.default],
        x = function x(e) {
      return Object.keys(v.default).forEach(function (r) {
        -1 !== e.indexOf(r) && (e = e.replace(new RegExp(r, "g"), v.default[r][0]));
      }), e;
    },
        q = function q(e) {
      var r = e.split(" ");
      return r.forEach(function (e, t) {
        var n = null;
        Object.keys(v.default).forEach(function (i) {
          -1 !== e.indexOf(i) && (n = i, r[t] = e.replace(new RegExp(i, "g"), v.default[i][0]));
        }), r[t] += v.default[n][1];
      }), r.join(" ");
    },
        _ = function _(e, r) {
      ...
      for (var t = e.match(/[\u4E00-\u9FA5]*/g).join(""), n = 0, i = E.length; n < i; n++) {
        var a = !1,
            u = !0,
            o = !1,
            f = void 0;
        ...
        try {
          for (var c, l = Object.keys(E[n])[Symbol.iterator](); !(u = (c = l.next()).done); u = !0) {
            var d = c.value;

            if (-1 !== t.indexOf(d) && (t = t.replace(new RegExp(d, "g"), E[n][d]), !p.test(t))) {
              t = t.replace(/ /, ""), r.numberTone ? t = q(t) : r.noTone && (t = x(t)), a = !0;
              break;
            }
          }
        } catch (y) {
      ...
      return r.filterChinese && function () {
        t = t.split(" ");
        var r = [""],
            i = !1,
            a = e.length;
        ...
        for (n = 0; n < a; n++) {
          p.test(e[n]) ? (r.push(""), i = !0) : (i ? r[r.length] = e[n] : r[r.length - 1] += e[n], i = !1);
        }
    ...
    "../dictionary/dictionary_1": "9hQC",
    "../dictionary/dictionary_2": "ssGj",
    "../dictionary/dictionary_3": "MWph",
    "../dictionary/dictionary_4": "8te5",
    "../dictionary/dictionary_5": "ON4E",
    "../dictionary/dictionary_6": "KdY1",
    "../dictionary/surnames": "QeaK",
    "./tone": "gZcI"
  }],
  "fmWg": [function (require, module, exports) {
  ...
  "QvaY": [function (require, module, exports) {
    ...
    var e = o(require("chinese-to-pinyin")),
        t = o(require("./audio_visualizer")),
        n = o(require("./firebase_util"));
    ...
    function a() {
      var t = document.getElementById("chinese").value,
          n = (0, e.default)(t);
      document.getElementById("pinyin").value = n, console.log(t + " to " + n);
    }

    document.getElementById("chinese").onkeydown = a, document.getElementById("chinese").onpaste = a;
    var d,
        c = document.getElementById("player"),
        i = !1,
        l = !1,
        u = document.getElementById("download"),
        s = document.getElementById("stop");
    s.addEventListener("click", function () {
      console.log("stop"), i = !0;
    });
    ...
    var r = function r(e) {
      ...
      n.ondataavailable = function (e) {
        console.log("avail"), e.data.size > 0 && t.push(e.data), !0 === i && !1 === l && (n.stop(), l = !0);
      }, n.addEventListener("stop", function () {
        d = new Blob(t), u.href = URL.createObjectURL(d), u.download = "acetest.wav", c.src = u.href;
      }), console.log("mediaRecorder start"), n.start(1e3);
    };

    document.getElementById("start").onclick = function () {
      console.log("start"), i = !1, l = !1, navigator.mediaDevices.getUserMedia({
        audio: !0,
        video: !1
      }).then(r);
      ...
      console.log("submit"), n.default.uploadData();
    };
  }, {
    "chinese-to-pinyin": "fmWg",
    "./audio_visualizer": "f9qx",
    "./firebase_util": "gi+R"
  }]
}, {}, ["QvaY"], null);
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","js.f4a89ca1.js"], null)
//# sourceMappingURL=/js.f4a89ca1.e4ecb88e.map